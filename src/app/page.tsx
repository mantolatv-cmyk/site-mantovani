        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
            {[
              ...
              { name: "Escoras Metálicas", desc: "Reguláveis e de alta resistência. Suporte essencial para escoramento de vigas e lajes com máxima segurança.", cap: "Até 4.0 metros", img: "/escoras_metalicas.png" }
            ].map((maq, i) => (
